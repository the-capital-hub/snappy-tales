...
paths.forEach((path, index) => {
  if (path) {
    ...
    masterTl.to(path, {
      ...
      // Scale down SVG container to original size
      masterTl.to(
        svgContainerRef.current,
        {
          scale: 1,
  ...
  return (
    <div>
      <div className="relative w-full px-5 mx-auto overflow-hidden">
        {/* Background Circle */}
        ...
        <div
          ref={svgContainerRef}
          className="flex justify-center items-center mt-18 mb-9"
        >
          <svg
            width="888"
            height="280"
        ...
        <div
          ...
          className={`${mont.className} flex items-center flex-col justify-center gap-2`}
        >
          <h1 className="text-5xl text-black font-bold max-w-4xl text-center leading-15">
